...
export const CHANGELOG: ClgVersion[] = [
  {
    ...
    items: [
      ...
      it("imp", "吸附反馈改为「进入闪一次、期间常亮、离开再闪一次」：一次拖动里第一次吸上某个画布时闪一道亮绿并震一下，之后只要手指还在吸附范围内，那道空隙就一直保持绿色；把画布拉出范围时会再闪一下红色并消失，松手成组后由常驻的绿色接管", "Snap feedback is now enter-flash / stay-lit / leave-flash: the first time a drag engages a canvas it flashes bright green with a haptic tick, then the gap stays lit green for as long as your finger keeps it in range. Pulling away flashes red once and clears it, and once you release the permanent grouped highlight takes over"),
