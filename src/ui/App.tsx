...
function TimelineBar({ t, snap, onFrameDlg }: { t: ReturnType<typeof makeT>; snap: Snapshot; onFrameDlg: (fi: number) => void }) {
 ...
 */
function Keep({ on, el, ms = 200 }: { on: boolean; el: React.ReactNode; ms?: number }) {
